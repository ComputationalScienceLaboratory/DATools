function LF = popovsandu2017_new3_DEnKF(rmin, rmax, nrs, rsfun, distfun, m, locfun, betamean, D, inflation)
...
Jn = @(b) costfun(PfHt, locfun, numVars, b, rsfun, distfun, t, y, m, d, H, R, betamean, D, Xf, Y, Af, inflation, rmin, rmax);
...
function [J, Jf, Ju, Jo] = costfun(PfHt, locfun, n, beta, rsfun, distfun, t, y, m, d, H, R, bm, Di, Xf, Y, Af, inflation, rmin, rmax)
% fprintf('%.5e\n',beta);
% Y = mean(Ys, 2);
